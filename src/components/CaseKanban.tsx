...
/** Tablero principal de Cases (item 20-21) — 3 columnas por current_state, sin
 * drag-and-drop (item 36: se prioriza estabilidad/claridad sobre esa interaccion). Cambiar
 * de estado se hace desde el drawer (click en la card). Riesgo (AT_RISK) es una dimension
 * independiente de current_state — no tiene columna propia, ver CaseAtRiskSection. */
